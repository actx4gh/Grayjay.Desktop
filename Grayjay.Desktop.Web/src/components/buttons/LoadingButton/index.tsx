...
const LoadingButton: Component<LoadingButtonProps> = (props) => {
    ...
    return (
        <div class={styles.container} onClick={handleClick} style={{... props.style, "background-color": props.color ?? "var(--gj-bg-control)", width: props.style?.width ?? "fit-content"}} classList={{[styles.small]: props.small}}>
